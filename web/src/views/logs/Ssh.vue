      ...
      this.socket.onopen = function () {
        ...
        _this.pangeeClusterApi
          ...
          .then(resp => {
            ...
            _this.roles = {
              kube_control_plane:
                inventory.all.children.target.children.k8s_cluster.children.kube_control_plane.hosts[_this.nodeName] !==
                undefined,
            ...
            if (
              inventory.all.hosts[_this.nodeName].ansible_become !== undefined
                ? inventory.all.hosts[_this.nodeName].ansible_become
                : inventory.all.children.target.vars.ansible_become
            ) {
              setTimeout(() => {
